...
class TestBowlingGame(unittest.TestCase):
    ...
    def test_create_10_frames(self):
        game = BowlingGame()
    ...
    def test_expect_11_frames_throws(self):
        game = BowlingGame()
        game.add_frame(Frame(1, 5))
        game.add_frame(Frame(3, 6))
        game.add_frame(Frame(7, 2))
        ...
        self.assertRaises(BowlingError, game.add_frame, Frame(2, 2))
    ...
    def test_calculate_score_strike_and_strike(self):
        game = BowlingGame()
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(10, 0))
        game.add_frame(Frame(7, 2))
    ...
    def test_calculate_score_spare_and_spare(self):
        game = BowlingGame()
